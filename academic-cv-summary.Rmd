...
This CV has been created from the [dynamic CV template](https://github.com/JJ/dynamic-academic-cv-template), which is released under the [Affero GPL license](https://www.gnu.org/licenses/agpl-3.0.en.html). Make your own by instantiating the template.